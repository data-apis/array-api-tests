...
def test_divide_special_cases_two_args_either(pair):
    """
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_either__either_1(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_either__either_2(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__greater_1(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__greater_2(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__less_1(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__less_2(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_greater__equal_1(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_greater__equal_2(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_less__equal_1(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_less__equal_2(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__equal_1(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__equal_2(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__equal_3(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__equal_4(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__equal_5(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__equal_6(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__equal_7(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_equal__equal_8(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_same_sign_both(pair):
    """
    Special case test for `divide(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_divide_special_cases_two_args_different_signs_both(pair):
    """
    Special case test for `divide(x1, x2, /)`:
