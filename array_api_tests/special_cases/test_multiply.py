...
def test_multiply_special_cases_two_args_either(pair):
    """
...
@given(broadcastable_floating_array_pairs())
def test_multiply_special_cases_two_args_either__either_1(pair):
    """
    Special case test for `multiply(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_multiply_special_cases_two_args_either__either_2(pair):
    """
    Special case test for `multiply(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_multiply_special_cases_two_args_either__either_3(pair):
    """
    Special case test for `multiply(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_multiply_special_cases_two_args_same_sign_except(pair):
    """
    Special case test for `multiply(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_multiply_special_cases_two_args_different_signs_except(pair):
    """
    Special case test for `multiply(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_multiply_special_cases_two_args_either__equal(pair):
    """
    Special case test for `multiply(x1, x2, /)`:
...
@given(broadcastable_floating_array_pairs())
def test_multiply_special_cases_two_args_equal__either(pair):
    """
    Special case test for `multiply(x1, x2, /)`:
